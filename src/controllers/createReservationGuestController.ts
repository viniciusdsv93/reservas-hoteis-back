...
import { CreateReservationGuestService } from "../services/createReservationGuestService";
import { GuestData } from "../types/guestData";

const createReservationGuestService = new CreateReservationGuestService();

export class CreateReservationGuestController {
